...
import com.mankart.mynotesapp.adapter.NoteAdapter
import com.mankart.mynotesapp.databinding.ActivityMainBinding
import com.mankart.mynotesapp.entity.Note
import com.mankart.mynotesapp.adapter.NoteAdapter.OnItemClickCallback
import com.mankart.mynotesapp.db.NoteHelper
import com.mankart.mynotesapp.helper.MappingHelper
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = NoteAdapter(object : OnItemClickCallback {
            override fun onItemCallback(selectedNote: Note?, position: Int?) {
